...
{
    /// <inheritdoc />
    public partial class AddWorkLogModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkedHours = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    ...
                    PaymentMonth = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkLogs_UserId_Status",
                table: "WorkLogs",
                columns: new[] { "UserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkLogs_UserId_WorkDate",
                table: "WorkLogs",
